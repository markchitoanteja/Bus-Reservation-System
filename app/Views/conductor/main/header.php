...
<head>
    ...
    <!-- AdminLTE -->
    <link rel="stylesheet" href="<?= base_url() ?>public/dist/conductor/css/sweetAlertStyle.css">
    <link rel="stylesheet" href="<?= base_url() ?>public/dist/conductor/css/adminlte.min.css">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Conductor</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="ticketing_payment"
                                class="nav-link <?= session()->get( 'active_tab' ) === 'ticketing_payment' ? 'active' : '' ?>">
                                <span class="fa-stack mb-1 mr-1"
                                    style="font-size: 1em; width: 1.50em; height: 1.50em; line-height: 1.50em;">
                                    <!-- Ticket background -->
                                    <i class="nav-icon fa-solid fa-ticket-simple fa-stack-1x"></i>
                                    <!-- Peso sign inside -->
                                    <i class="nav-icon fa-solid fa-peso-sign fa-stack-1x text-dark"
                                        style="font-size: 0.7em;"></i>
                                </span>
                                <p>Ticketing & Payment</p>
                            </a>
                        </li>
